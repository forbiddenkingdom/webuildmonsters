                    ...
                    <ul>
                        @foreach($query as $query_res)
                            @if($relationshipField === 'payment_request_hasmany_attachment_relationship' && $query_res instanceof \App\Model\Attachment)
                                <li>
                                    <a href="{{ asset(\App\Providers\AttachmentServiceProvider::getFilePathByAttachment($query_res)) }}" target="_blank">
                                        {{ asset(\App\Providers\AttachmentServiceProvider::getFilePathByAttachment($query_res)) }}
                                    </a>
                                </li>
                            @else
