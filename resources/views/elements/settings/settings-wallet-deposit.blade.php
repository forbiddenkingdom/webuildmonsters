    ...
    <div class="payment-method">
        ...
        @if(getSetting('payments.allow_manual_payments'))
            <div class="custom-control custom-radio mb-1">
                ...
                <label class="custom-control-label stepTooltip" for="customRadio4" title="">Manual</label>
            </div>
            <div class="manual-details d-none">
                ...
                <p class="mb-1 mt-2">{{__("Please attach clear photos with one the following: check, money order or bank transfer. This transaction will be manually processed")}}</p>
